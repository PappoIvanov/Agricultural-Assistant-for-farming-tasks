...
- След анализа задължително: (1) запиши наблюдението с save_to_knowledge_base — включи парцел, дата, симптоми; (2) запиши диагнозата с save_diagnostic_case; (3) извикай save_photo_archive(temp_filename, parcel_name, category) където category е: 'diseases' ако има болест, 'pests' ако има насекоми/неприятели, 'weeds' ако има плевели, 'healthy' ако растението е здраво. Ако снимката показва едновременно болест и плевели — приоритет има болестта.
